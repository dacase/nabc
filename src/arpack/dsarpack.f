...
c         print *, ' ERROR with _SSIMP: Spectrum .NE. (SM|SA|LA|LM|BE)'
         go to 9000
      end if
c
      if ( n .gt. maxn ) then
c        print *, ' ERROR with _SSIMP: N is greater than MAXN '
         go to 9000
      else if ( nev .gt. maxnev ) then
c        print *, ' ERROR with _SSIMP: NEV is greater than MAXNEV '
         go to 9000
      else if ( ncv .gt. maxncv ) then
c        print *, ' ERROR with _SSIMP: NCV is greater than MAXNCV '
         go to 9000
      end if
c
c     %-----------------------------------------------------%
...
c
c           print *, ' '
c           print *, ' Error with _seupd, info = ', ierr
c           print *, ' Check the documentation of _seupd. '
c           print *, ' '
            go to 9000
c
...
c
            ...
            if ( nconv .le. 0 ) then
c              print *, ' '
c              print *, ' ARPACK: Not a single mode converged.'
c              print *, ' '
               go to 9000
            endif
c
